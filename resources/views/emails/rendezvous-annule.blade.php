      ...
      <td style="padding:36px 40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2;border:1px solid #fca5a5;border-radius:6px;margin-bottom:24px;">
          <tr><td style="padding:14px 18px;">
            <p style="font-size:13px;font-weight:bold;color:#991b1b;margin:0 0 2px;">Rendez-vous annulé</p>
            <p style="font-size:12px;color:#991b1b;margin:0;">Vous pouvez en prendre un nouveau dès maintenant.</p>
          </td></tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fdf6;border:1px solid #e8f5e4;border-radius:6px;margin-bottom:24px;">
          <tr><td style="padding:16px 18px;">
            <p style="font-size:11px;font-weight:bold;letter-spacing:1px;text-transform:uppercase;color:#2D5A27;margin:0 0 12px;">Rendez-vous annulé</p>
