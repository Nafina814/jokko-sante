...
<title>Nouvel Article — Jokko Santé</title>
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('admin.articles.store') }}">
                ...
                <div class="field">
                    ...
                    <input type="text" name="titre" value="{{ old('titre') }}" placeholder="Un titre clair et accrocheur..." required>
                </div>
                ...
                <div class="field">
                    <label>Contenu</label>
                    <textarea name="contenu" placeholder="Rédigez votre article ici..." required>{{ old('contenu') }}</textarea>
                </div>
